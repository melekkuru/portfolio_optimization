...
def run_task4():
    """
    Task 4: Portfolio Optimization with Short Selling Allowed
    Minimize portfolio risk under the constraint that allocations sum to 1 and weights can be negative.
    """
    # Problem Parameters
